...
namespace SafetyAndSecurityForNSI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        SSFORNSIDBFinalEntities pdb = new SSFORNSIDBFinalEntities();
        ...
        //new added By hasan
        private void SignInUser(ApplicationUser username, bool isPersistent)
        {
        ...
        private ActionResult RedirectToLocal(string returnUrl)
        {
            ...
            {
                return RedirectToAction("UserView", "DashBoard");
            }
